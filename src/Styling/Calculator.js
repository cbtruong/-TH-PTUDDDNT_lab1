...
const Calculator = () => {
	...
	const bgColorNumber = darkMode ? "#393d46" : "#ffffff";
	const bgColorResult = darkMode ? "#282f3b" : "#f5f5f5";
	const bgColorIcon = darkMode ? "#7b8084" : "#e5e5e5";
	...
	return (
		<View style={{ ...myStyles.container }}>
			...
			>
				...
				<Text
					style={{ ...myStyles.historyText, color: textColorHistory }}
				>
					{lastNumber}
				</Text>
